...
ALTER TABLE MEMBER_SOCIAL DROP CONSTRAINT UQ_MEMBER_SOCIAL_MSSN;

CREATE TABLE MEMBER_SOCIAL (
    MEMBER_SOCIAL_MEMBER_NO NUMBER,
    MEMBER_SOCIAL_SOCIAL_NAME VARCHAR2(20) NOT NULL,
...
--신고
ALTER TABLE REPORT ADD STATUS CHAR(1CHAR) DEFAULT 'N' NOT NULL;
...
CREATE TABLE REPORT (
    ...
    STATUS CHAR(1CHAR) DEFAULT 'N' NOT NULL,
