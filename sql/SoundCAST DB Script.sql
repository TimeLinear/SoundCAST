...
CREATE TABLE MEMBER_BANNER (
	...
	MEMBER_BANNER_PATH	VARCHAR2(255),
...
CREATE TABLE SOCIAL_CATEGORY (
	SOCIAL_CATEGORY_NO  NUMBER,
	SOCIAL_CATEGORY_NAME    VARCHAR2(15),
    
    CONSTRAINT PK_SOCIAL_CATEGORY_SCN PRIMARY KEY (SOCIAL_CATEGORY_NO)
);

COMMENT ON COLUMN SOCIAL_CATEGORY.SOCIAL_CATEGORY_NAME IS '0 - 구글
1 - 네이버
2 - 카카오';

CREATE TABLE MEMBER_GRADE (
	MEMBER_GRADE_NO NUMBER,
	MEMBER_GRADE_NAME	VARCHAR2(15),
...
CREATE TABLE MEMBER (
	...
	MEMBER_SOCIAL_CATEGORY	NUMBER	NOT NULL,
    ...
    CONSTRAINT FK_MEMBER_MSC FOREIGN KEY (MEMBER_SOCIAL_CATEGORY) REFERENCES SOCIAL_CATEGORY (SOCIAL_CATEGORY_NO),
...
CREATE TABLE SONG_IMAGE (
	SONG_IMAGE_NO	NUMBER	DEFAULT 0,
	SONG_IMAGE_PATH_NUMBER	NUMBER	NOT NULL,
	SONG_IMAGE_NAME	VARCHAR2(30)	NOT NULL,
    
    CONSTRAINT FK_SONG_IMAGE_SIPN FOREIGN KEY (SONG_IMAGE_PATH_NUMBER) REFERENCES SONG_IMAGE_PATH (SONG_IMAGE_PATH_NO),
